$(document).ready(function () {
    ...
    var table = $('#news_table').DataTable({
        ...
        serverSide: true,
        ajax: {
        url: window.APP_URLS.getNewsData,
        type: "GET",
    ...
    $(document).on('click', '.delete_news', function () {
        ...
        var url = window.APP_URLS.deletenews.replace(':id', id);
...
function validateAndPreviewImage() {
    ...
    const errorSpan = document.getElementById("span_news_image");
    const previewImg = document.getElementById("preview_news_image");
    const bannerId = document.getElementById("span_news_image_id")?.value;
    ...
    if (!file) {
        errorSpan.innerText = "news image is required.";
