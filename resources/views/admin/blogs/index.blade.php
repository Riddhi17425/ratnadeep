...
<div class="body-wrapper">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('blogs.create') }}" class="btn btn-primary">
            <i class="icofont-plus"></i> Add Blog
        </a>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '.status-toggle', function () {
            ...
            var newStatus = isChecked ? 'published' : 'draft';
                ...
                success: function (response) {
                    if (response.success) {
                        if (isChecked) {
                            ...
                            showAppToast('success', 'This Blog is Now Active.');
                        } else {
                            statusText.text('Inactive').removeClass('bg-success').addClass('bg-secondary');
                            showAppToast('success', 'This Blog is Now Inactive.');
                        }
                    } else {
